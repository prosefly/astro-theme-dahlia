---
title: Images
description: Author images, galleries, figures, and iframe embeds in Dahlia docs.

---

Dahlia supports standard Markdown images, raw HTML images, figures with captions,
...
When a paragraph contains only images, Dahlia converts that paragraph into a
...
whitespace. If text appears in the same paragraph, Dahlia keeps it as normal
inline content.
...
<figure>
  ...
  <figcaption>
    ...
    paragraph, and Dahlia styles that case correctly.
  </figcaption>
</figure>
```
...
Dahlia styles raw images the same way it styles Markdown images.

## Iframe Embeds

Users can write raw iframes directly in MDX. Dahlia applies prose spacing,
...
Dahlia prose applies these defaults:
