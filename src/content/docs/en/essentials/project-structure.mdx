...
description: Choose a Dahlia project layout based on routing, localization, and customization needs.

---

import { FileTree, Steps } from '@prosefly/astro-components';

Dahlia does not require one fixed directory layout. Start with the smallest
...
- theme.config.json stores Dahlia theme config
- src
