...
<CardGrid>
  ...
  <Card icon="lucide:workflow" title="Mermaid" href="#mermaid">
    Render fenced Mermaid diagrams with theme-aware client-side output.
  </Card>
</CardGrid>
...
integration. Write a fenced `mermaid` code block to render a diagram; Dahlia
also excludes Mermaid source from Shiki syntax highlighting.

See [Mermaid Diagrams](/docs/essentials/mermaid/) for syntax and examples.
