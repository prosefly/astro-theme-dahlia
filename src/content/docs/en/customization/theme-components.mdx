...
keeping the default copy, Markdown, ChatGPT, Claude, Grok, and Perplexity behavior.
...
The theme mode control uses the `dahlia-theme` local storage key and updates the
