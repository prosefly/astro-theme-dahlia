...
Dahlia components are published from `@prosefly/astro-components` <Badge color="accent">New</Badge>,
and can be used independently from the Dahlia theme <Badge color="success">Stable</Badge>.
...
Install Dahlia with Astro <Badge variant="subtle" color="accent">v7</Badge> and
