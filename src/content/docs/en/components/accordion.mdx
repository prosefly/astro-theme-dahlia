...
<Accordions>
  <AccordionItem title="What is Dahlia?">
    Dahlia is an Astro documentation theme with a configurable docs shell,
    routing integration, design tokens, and shared MDX components.
  </AccordionItem>
  <AccordionItem title="Can I use these components outside Dahlia?">
...
<Accordions>
  <AccordionItem title="What is Dahlia?">
    Dahlia is an Astro documentation theme.
  </AccordionItem>
...
<Accordions>
  <AccordionItem title="Which files configure Dahlia?">
    Most projects use a small set of configuration files.

    - `astro.config.ts` registers the integration.
    - `theme.config.json` configures the docs theme.
...
<Accordions multiple>
  ...
  <AccordionItem title="Navigation" defaultOpen>
    Use `docsNav` and `siteNav` to define how readers move through the docs.
  </AccordionItem>
...
<Accordions defaultValue="navigation-settings">
  ...
  <AccordionItem title="Navigation settings" value="navigation-settings">
    Configure site nav links, docs nav groups, and page actions.
  </AccordionItem>
</Accordions>
