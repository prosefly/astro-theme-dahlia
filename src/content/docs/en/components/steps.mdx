...
1. **Install the package.**
   ...
   Add Dahlia and the shared MDX components to your Astro project.

2. **Configure the integration.**

   Register the Dahlia integration in `astro.config.ts` and point it at your
   docs content.
...
the guide line are handled by the component CSS and Dahlia design tokens.
