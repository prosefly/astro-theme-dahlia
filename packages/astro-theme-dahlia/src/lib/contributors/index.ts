...
import type { ContributorInfo, ContributorsConfig, DahliaThemeConfig } from '../theme';
...
export function getEntrySourcePath(config: DahliaThemeConfig, entry: DocsEntry): string {
