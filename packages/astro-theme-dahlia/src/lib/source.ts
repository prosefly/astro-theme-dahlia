...
import type { DahliaThemeConfig, ThemeSourceConfig } from './theme';
...
export function resolveSourceConfig(config: DahliaThemeConfig): ThemeSourceConfig {
  return {
